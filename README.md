...
<table align="center">
    ...
    <tbody>
         <tr>
            <td><img alt="Stars" src="https://img.shields.io/github/stars/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-?style=flat&logo=github"/></td>
             <td><img alt="Forks" src="https://img.shields.io/github/forks/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-?style=flat&logo=github"/></td>
            <td><img alt="Issues" src="https://img.shields.io/github/issues/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-?style=flat&logo=github"/></td>
            <td><img alt="Open Pull Requests" src="https://img.shields.io/github/issues-pr/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-?style=flat&logo=github"/></td>
           <td><img alt="Closed Pull Requests" src="https://img.shields.io/github/issues-pr-closed/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-?style=flat&color=critical&logo=github"/></td>
        </tr>
    </tbody>
</table>
</div>
...
<p style="font-family:var(--ff-philosopher);">To contribute to the Medipool-HEALTHCARE-WEBSITE repository, follow these steps:</p>
...
2. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/<your-github-username>/Medipool-HEALTHCARE-WEBSITE
   ```
3. **Add a remote upstream:**
   ```bash
   git remote add upstream https://github.com/original-owner-username/Medipool-HEALTHCARE-WEBSITE
   ```
...
1. _Fork the Repository:_
   ...
   ![Screenshot (127)](https://github.com/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-/assets/105973197/164ba1a7-d42e-4e4d-acbd-4bc81cf387d5)

   ![Screenshot (128)](https://github.com/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-/assets/105973197/21a47905-69ee-448f-a5c0-71ceb3c694d5)
...
2. _Clone the repository:_
   ...
   git clone https://github.com/<your-github-username>/Medipool-HEALTHCARE-WEBSITE
   ```
   ![Screenshot (129)](https://github.com/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-/assets/105973197/88249cc4-5849-4472-b190-9d9bad2bb236)


3. _Open the project in VS Code:_
   Click on the open with vs code button , to make changes to the code using the text editor.

   ![Screenshot (130)](https://github.com/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-/assets/105973197/10644887-eb4b-4471-98bb-26e0b1bb4f07)
...
4. _Find the Index.html file:_
   ...
   ![Screenshot (133)](https://github.com/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-/assets/105973197/62044e1a-a644-467d-98ac-eabfac970ed9)
...
To contribute to the Medipool-HEALTHCARE-WEBSITE repository using GitHub Desktop, follow these steps:
...
<a href="https://github.com/Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-/graphs/contributors">
<img src="https://contributors-img.web.app/image?repo=Anishkagupta04/Medipool-HEALTHCARE-WEBSITE-"/>
